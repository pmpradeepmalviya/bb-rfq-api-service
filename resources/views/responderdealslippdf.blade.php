                        ...
                        <div style="border: 1.4px solid #0e0e0e;border-radius:15px;overflow: hidden;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="overflow: hidden;">
                                <tr>
                                    ...
                                    <td colspan="3" style="width: 60%; padding: 5px; border-bottom: 1px solid #0e0e0e">{{$responder_details['name']}}</td>
                                </tr>
                                <tr>
                                    <td rowspan="" style="width: 20%;padding: 5px; border-right: 1px solid #0e0e0e;">
                                        <b>UCC</b>
                                    </td>
                                    <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e"><b>{{$responder_details['ucc']}}</b></td>
                                    <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e"><b>DP ID</b></td>
                                    <td style="width: 20%; padding: 5px;">{{$responder_details['dpid']}}</td>
                                </tr>
                            </table>
                        </div>
                        </td>
                            ...
                            <div style="border: 1.4px solid #0e0e0e;border-radius:15px;overflow: hidden;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                                    <tr>
                                        ...
                                        <td colspan="3" style="width: 60%; padding: 5px; border-bottom: 1px solid #0e0e0e">{{$responder_details['order_type']}}</td>
                                    </tr>
                                    <tr>
                                        <td rowspan="" style="width:20%;padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;">
                                            <b>Order No.</b>
                                        </td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;">{{$responder_details['order_no']}}</td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;"><b>Trade No</b></td>
                                        <td style="width: 20%; padding: 5px;border-bottom: 1px solid #0e0e0e;">{{$responder_details['trade_no']}}</td>
                                    </tr>
                                    <tr>
                                        <td rowspan="" style="width: 20%;padding: 5px; border-right: 1px solid #0e0e0e;">
                                            <b>Order Date & Time</b>
                                        </td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e">{{$responder_details['order_dtm']}}</td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e"><b>Trade Date & Time</b></td>
                                        <td style="width: 20%; padding: 5px;">{{$responder_details['trade_dtm']}}</td>
                                    </tr>
                                </table>
                            </div>
                        </td>
                            ...
                            <div style="border: 1.4px solid #0e0e0e;border-radius:15px;overflow: hidden;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                                    <tr>
                                        ...
                                        <td  style="width: 20%; padding: 5px;border-right: 1px solid #0e0e0e; border-bottom: 1px solid #0e0e0e">{{$responder_details['isin']}}</td>
                                        <td  style="width: 20%; padding: 5px;border-right: 1px solid #0e0e0e; border-bottom: 1px solid #0e0e0e"><b>Face Value</b></td>
                                        <td  style="width: 20%; padding: 5px; border-bottom: 1px solid #0e0e0e">{{$responder_details['face_value']}}</td>
                                    </tr>
                                    <tr>
                                        <td rowspan="" style="width: 20%;padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;">
                                            <b>Coupon %</b>
                                        </td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;">{{$responder_details['coupon_rate']}}</td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;"><b>Maturity Date</b></td>
                                        <td style="width: 20%; padding: 5px;border-bottom: 1px solid #0e0e0e;">{{$responder_details['maturity_date']}}</td>
                                    </tr>
                                    <tr>
                                        <td rowspan="" style="width: 20%;padding: 5px; border-right: 1px solid #0e0e0e;">
                                            <b>Security Name</b>
                                        </td>
                                        <td colspan="3" style=" padding: 5px;">{{$responder_details['security_name']}}</td>
                                    </tr>
                                </table>
                            </div>
                        </td>
                            ...
                            <div style="border: 1.4px solid #0e0e0e;border-radius:15px;overflow: hidden;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                                    <tr>
                                        ...
                                        <td  style="width: 20%; padding: 5px;border-right: 1px solid #0e0e0e; border-bottom: 1px solid #0e0e0e">{{$responder_details['clean_price']}}</td>
                                        <td  style="width: 20%; padding: 5px;border-right: 1px solid #0e0e0e; border-bottom: 1px solid #0e0e0e"><b>Accrued Interest</b></td>
                                        <td  style="width: 20%; padding: 5px; border-bottom: 1px solid #0e0e0e">{{$responder_details['accrued_interest']}}</td>
                                    </tr>
                                    <tr>
                                        <td rowspan="" style="width: 20%;padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;">
                                            <b>Dirty Price</b>
                                        </td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;">{{$responder_details['dirty_price']}}</td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;"><b>Yield</b></td>
                                        <td style="width: 20%; padding: 5px;border-bottom: 1px solid #0e0e0e;">{{$responder_details['yield']}}</td>
                                    </tr>
                                    <tr>
                                        <td rowspan="" style="width: 20%;padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;">
                                            <b>Stamp Duty</b>
                                        </td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;">{{$responder_details['stamp_duty']}}</td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e;border-bottom: 1px solid #0e0e0e;"><b>Quantity</b></td>
                                        <td style="width: 20%; padding: 5px;border-bottom: 1px solid #0e0e0e;">{{$responder_details['quantity']}}</td>
                                    </tr>
                                    <tr>
                                        <td rowspan="" style="width: 20%;padding: 5px; border-right: 1px solid #0e0e0e;">
                                            <b>Total Consideration</b>
                                        </td>
                                        <td colspan="3" style="padding: 5px;">{{$responder_details['total_consideration']}}</td>
                                    </tr>
                                </table>
                            </div>
                        </td>
                            ...
                            <div style="border: 1.4px solid #0e0e0e;border-radius:15px;overflow: hidden;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                                    <tr>
                                        ...
                                        <td  style="width: 20%; padding: 5px;border-right: 1px solid #0e0e0e; border-bottom: 1px solid #0e0e0e">{{$responder_details['settlement_no']}}</td>
                                        <td  style="width: 20%; padding: 5px;border-right: 1px solid #0e0e0e; border-bottom: 1px solid #0e0e0e">
                                            <b>Settlement Date</b>
                                        </td>
                                        <td  style="width: 20%; padding: 5px; border-bottom: 1px solid #0e0e0e">{{$responder_details['settlement_date']}}</td>
                                    </tr>
                                    <tr>
                                        <td rowspan="" style="width: 20%;padding: 5px; border-right: 1px solid #0e0e0e;">
                                            <b>Settlement Type</b>
                                        </td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e;">{{$responder_details['settlement_type']}}</td>
                                        <td style="width: 20%; padding: 5px; border-right: 1px solid #0e0e0e;">
                                            <b>Settlement Amount</b>
                                        </td>
                                        <td style="width: 20%; padding: 5px; color: #FF0000;"><b>{{$responder_details['settlement_amount']}}</b></td>
                                    </tr>
                                </table>
                            </div>
                        </td>
